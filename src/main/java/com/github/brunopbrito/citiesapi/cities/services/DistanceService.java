...
import com.github.brunopbrito.citiesapi.utils.StringLocationUtils;
...
public class DistanceService {
    ...
    public Double distanceUsingMath(final Long city1, final Long city2, final EarthRadius unit) {
        ...
        final Double[] location1 = StringLocationUtils.transform(cities.get(0).getLat_lon());
        final Double[] location2 = StringLocationUtils.transform(cities.get(1).getLat_lon());
